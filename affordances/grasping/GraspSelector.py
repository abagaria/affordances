...
from affordances.grasping.GraspClassifier import GraspClassifier
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default="affordances/grasping/pointclouds")
    ...
    test_cloud_file = f"{args.input}/{args.task}.ply"
